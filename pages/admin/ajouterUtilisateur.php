...
if(empty($_SESSION['auth']) || !isset($_SESSION['auth']) || $_SESSION['auth']['role'] != 'admin'){
...
if (!empty($_POST)) {
    if ($_POST['password'] != $_POST['password2']) {
        ...
        $keys = array("username", "nom", "prenom", "email", "sexe", "role", "date_embauche");
        $values = array(strtolower($_POST['nom'] . '' . $_POST['prenom']), $_POST['nom'], $_POST['prenom'], $_POST['email'], $_POST['sexe'], $_POST['role'], date("Y-m-d", strtotime($_POST['hiringDtae'])));
                                        ...
                                        <div class="form-group now grid-margin stretch-card">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="js-example-basic-single w-50" name="role">
                                                    ...
                                                    <option value="responsable de stock">Resp. de Stock</option>
